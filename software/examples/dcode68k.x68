...
IMVFUSP: MOVE.L  #$2c505355,D0 ; USP,
         BSR.S   SCHR
         BSR     FORMREGA
         BRA.S   CS11           ; COMMON
...
SCOMMON:
	bra COMMON         ; NOP RESET RTE RTR RTS TRAPV
...
EA1113:
	...
	bne.s EA1113A
FE11:
	bra FERROR         	; THIS MODE NOT ALLOWED
...
MOVEMR:  ;.align  2
         ...
         MOVE.W  #$4144,D4    ; "AD" D4 = REG CLASS
...
DCODE68K:
	...
	moveq #BUFSIZE,D0
DEC311:
  move.b #BLANK,(a6)+  ; SPACE FILL BUFFER
	subq.l #1,D0
	bne.s DEC311
	clr.b (a6)+					; NULL temrinate
...
DEC411:
	move.w (A4),D0      ;  FIRST WORD
	and.w (A5)+,D0     	;  MASK
	cmp.w (A5)+,D0
	beq.s DEC425        ; FOUND MATCH
	addq.l #4,A5        ; UPDATE POINTER
	cmp.l A6,A5
	blo.s DEC411        ; MORE TABLE
FE12:
	bra.s FERROR        ; ILLEGAL INSTRUCTION
DEC425:
  clr.l D6
	move.w (A5)+,D6     ; D6 = (GOTO OFFSET)/4
;         LSL.L   #2,D6
	clr.l D7
...
;	 A3 = pointer to beginning of buffer
