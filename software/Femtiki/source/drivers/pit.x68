...
init_pit:
	...
	; setup for vector #30, no mailbox
	move.l #$00001E07,$98(a0)	; load,enable,auto-reload,internal clock,ignore gate,set
	move.l #$00001E87,$98(a0)
	move.l #_FMTK_TimerISRLaunchpad,(30)*4	; override default for system tick timer
	move.l #16,$2000(a0)		; enable timer #4 interrupts
	rts
