...
if (rst_i) begin
	...
	if (cs_i & we_i)
		casez(adr_i[12:2])
		11'b0???????010:	maxcounth[adr_i[11:5]][31: 0] <= dat_i;
		11'b0???????011:	maxcounth[adr_i[11:5]][47:32] <= dat_i[15:0];
		11'b0???????100:	ontimeh[adr_i[11:5]][31:0] <= dat_i;
		11'b0???????101:	ontimeh[adr_i[11:5]][47:32] <= dat_i[15:0];
		11'b0???????110:
			begin
				if (dat_i[7]) begin
					ldh[adr_i[11:5]] <= 1'b0;
					ld[adr_i[11:5]] <= ldh[adr_i[11:5]];
					ce[adr_i[11:5]] <= ceh[adr_i[11:5]];
					...
					ldh[adr_i[11:5]] <= dat_i[0];
					ceh[adr_i[11:5]] <= dat_i[1];
...
//		11'b10000101000:	ce[31:0] <= ce[31:0] & ~dat_i;
	...
	if (cs_i)
		...
		11'b0???????000:	
			begin
				dat_o <= count[adr_i[11:5]][31:0];
				counth[adr_i[11:5]] <= count[adr_i[11:5]];
			end
		11'b0???????001:	dat_o <= {16'd0,counth[adr_i[11:5]][47:32]};
		11'b0???????010:	dat_o <= maxcounth[adr_i[11:5]][31: 0];
		11'b0???????011:	dat_o <= {16'd0,maxcounth[adr_i[11:5]][47:32]};
		11'b0???????100:	dat_o <= ontimeh[adr_i[11:5]][31:0];
		11'b0???????101:	dat_o <= {16'd0,ontimeh[adr_i[11:5]][47:32]};
		11'b0???????110:
			begin
				dat_o[0] <= 1'b0;
...
//		11'b0???????111:	dat_o <= vector[adr_i[11:5]];
		11'b10000000000:	dat_o <= ie[31:0];
		11'b10000000001:	dat_o <= ie[63:32];
	//	11'b10000000010:	dat_o <= ie[95:64];
	//	11'b10000000011:	dat_o <= ie[127:96];
		11'b10000000100:	dat_o <= irqf[31:0];
		11'b10000000101:	dat_o <= irqf[63:32];
	//	11'b10000000110:	dat_o <= irqf[95:64];
	//	11'b10000000111:	dat_o <= irqf[127:96];
		11'b10000001000:	dat_o <= underflow[31:0];
		11'b10000001001:	dat_o <= underflow[63:32];
	//	11'b10000001010:	dat_o <= underflow[95:64];
	//	11'b10000001011:	dat_o <= underflow[127:96];
		11'b10000010000:	dat_o <= {24'd0,vector};
		default:	dat_o <= 32'd0;
		endcase
